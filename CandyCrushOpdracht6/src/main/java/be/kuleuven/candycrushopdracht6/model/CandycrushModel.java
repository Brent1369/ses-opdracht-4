...
public class CandycrushModel {
    ...
    public void candyWithIndexSelected(int index){
        ...
        if (index >= 0 && index < width * height){
            ...
            Iterable<Integer> directNeighbours = List.of(   0, 0, 1, 0,
                    1, 1, 0, 2,
                    2, 0, 1, 3,
                    0, 1, 1, 1 );

            directNeighbours = getSameNeighboursIds(speelbord, 4, 4, index);
            ...
            int i = 0;
            for(Integer neigbour : directNeighbours) {
            ...
            if ( i >=3){
                for(Integer neigbour : directNeighbours) {
                    ...
                    randomGetal = random.nextInt(5) + 1;
                    speelbord.set(neigbour, randomGetal);
                }
                score= score + i;
            }
